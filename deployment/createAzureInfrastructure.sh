...
## -------
# Sleep for one minute to allow the service principal to provision fully
sleep 60s
...
## -------
# Sleep for two minutes to allow the managed disks to provision fully
sleep 120s

## -------
## Get the resource group that is generated by AKS that contains the AKS nodes
AKS_NODE_RESOURCE_GROUP=$(az aks show -n $AKS_CLUSTER_NAME -g $AZURE_RESOURCE_GROUP --query nodeResourceGroup -o tsv)
